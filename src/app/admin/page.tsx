    ...
    <AdminLayout>
                ...
                <tr key={index} className="border-t border-gray-200">
                  ...
                  <td className="flex items-center gap-2 mt-2">
                    <button
                      ...
                      onClick={() =>
                        handleApproval(payments.indexOf(payment))
                      }
                    >
                      <CheckIcon size={16} />
                    </button>
      ...
      {tab === 'verifiedpayments' && (
        <div className="bg-white p-6 rounded-md shadow">
          ...
          <p className="text-black mb-4">
            List of payments approved by admin.
          </p>
      ...
      {tab === 'memberinfo' && (
        <div className="bg-white p-6 rounded-md shadow">
          ...
          <p className="text-black mb-4">
            List of all registered members with their details.
          </p>
              ...
              <div className="text-sm text-gray-700">
                {dummyVehicles.map((v, i) => (
                  <div key={i} className="mb-2">
                    <p>
                      <strong>RC:</strong> {v.rc}
                    </p>
                    <p>
                      <strong>Number:</strong> {v.number}
                    </p>
                    <p>
              ...
              <div className="text-sm text-gray-700">
                {dummyFamily.map((f, i) => (
                  <div key={i} className="mb-2">
                    ...
                    <p>
                      <strong>Relation:</strong> {f.relation}
                    </p>
                    <p>
                      <strong>Aadhar:</strong> {f.aadhar}
                    </p>
                  </div>
                ))}
              </div>
